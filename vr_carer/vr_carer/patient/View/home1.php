...
<link rel="icon" type="image/png" sizes="32x32" href="./storages~origin_main/logo/VR1.png" />
    <title>Home</title>
    <!-- Google Font -->
                ...
                <ul class="splide__list">
                    <li class="splide__slide">
                        <div class="first_slide_div">
                            <img src="./storages~origin_main/image/<?=$carouselInfo[0]["caroussel_image"]?>" alt="" class="first_slide_img" />
                        </div>
                    </li>
                    <li class="splide__slide">
                        <div class="first_slide_div">
                            <img src="./storages~origin_main/image/<?=$carouselInfo[0]["caroussel_image_2"]?>" alt="" class="first_slide_img" />
                        </div>
                    </li>
                    <li class="splide__slide">
                        <div class="first_slide_div">
                            <img src="./storages~origin_main/image/<?=$carouselInfo[0]["caroussel_image_3"]?>" alt="" class="first_slide_img" />
                        </div>
                    </li>
                    <li class="splide__slide">
                        <div class="first_slide_div">
                            <img src="./storages~origin_main/image/<?=$carouselInfo[0]["caroussel_image_4"]?>" alt="" class="first_slide_img" />
                        </div>
                    </li>
